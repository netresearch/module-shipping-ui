define([
     ...
     *     items: {}
     *     packageId: int
     * }} NrShippingCurrentSelection
     *
     * @property NrShippingCurrentSelection[]
     */
    var selections = [];


    /**
     * @callback NrShippingOptionSelectionObservable
     * @param {NrShippingCurrentSelection} [value]
     * @return {NrShippingCurrentSelection}
     *
     * @property NrShippingOptionSelectionObservable
     */
     ...
     *      >
     *  >
     * } NrShippingItemSelections
     */

    /**
     * Item selection data only, for when you only want to be notified of selection changes to item inputs.
     *
     * @callback NrShippingSelectionItemsObservable
     * @param {NrShippingItemSelections} [value]
     * @return {NrShippingItemSelections}
     *
     * @property NrShippingSelectionItemsObservable
     */
    var currentItems = ko.observable({}).extend({rateLimit: {timeout: 50, method: 'notifyWhenChangesStop'}});

    return {
        /**
         * @return {NrShippingOptionSelectionObservable}
         */
        get: function () {
        ...
        /**
         *
         * @return {NrShippingSelectionItemsObservable}
         */
        ...
        /**
         * @param {NrShippingCurrentSelection} newSelection
         */
        ...
        /**
         *
         * @param {NrShippingCurrentSelection[]} newSelections
         */
