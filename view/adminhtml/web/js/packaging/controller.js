define([
    ...
    /** @property {NrShippingSettings} shippingSettings **/

    return Component.extend({
        defaults: {
            template: 'Netresearch_ShippingUi/packaging/control',
            errors: [],
            submitUrl: '',
            successRedirect: '',
        ...
        initShipmentItems: function () {
            ...
            if (itemQtyElements.length > 0) {
                ...
                qtyMap = self.shippingSettings.carriers[0].item_options.map(function (itemOption) {
                    /** @type {NrShippingInput|undefined} */
        ...
        generateItemSelectionFieldset: function () {
            ...
            fieldset.component = 'Netresearch_ShippingUi/js/packaging/view/item-controller';
        ...
        generateFieldset: function (name, label, options) {
            return {
                component: 'Netresearch_ShippingUi/js/packaging/view/fieldset',
                label: label,
                name: name,
                parent: self.name,
                additionalClasses: 'nrshipping-fieldset ' + name,
