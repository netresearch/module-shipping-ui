...
namespace Netresearch\ShippingUi\ViewModel\Order\Packaging;
 ...
 *
 * @see \Netresearch\ShippingCore\Model\ShippingSettings\PackagingDataProvider
 */
    ...
    public function getSubmitUrl(): string
    {
        if ($this->getShipment()->getId() !== null) {
            $submitUrl = $this->urlBuilder->getUrl(
                'nrshipping/order_shipment/save/order_id/*/shipment_id/*/',
                [
            ...
            $submitUrl = $this->urlBuilder->getUrl(
                'nrshipping/order_shipment/save/order_id/*/',
                [
                    'order_id' => $this->getShipment()->getOrderId(),
                ]
            );
